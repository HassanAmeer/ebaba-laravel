    ...
    * {
            ...
            <div class="bannerSlidesItem">
                <center>
                    ...
                    <div class="banner-design-outer"
                        style=" opacity: {{$key['bigAreaOpacity'] }}; background-color: {{$key['bigAreaColor']}}; background-image:url('{{ asset($baseUrl.'/uploads/'.$key['bigAreaBgImage']) }}');">
                        @else
                        <div class="banner-design-outer"
                            style=" opacity: {{$key['bigAreaOpacity'] }}; background-color: {{$key['bigAreaColor']}};">
                            @endif
                            ...
                            <div class="banner-design-inner"
                                style=" opacity: {{$key['smallAreaOpacity'] }}; background-color: {{$key['smallAreaColor']}}; display: flex; flex-direction: column;justify-content: center; background-image:url('{{ asset($baseUrl . '/uploads/' . $key['smallAreaBgImage']) }}');">
                                @else
                                <div class="banner-design-inner"
                                    style="opacity: {{$key['smallAreaOpacity'] }}; background-color: {{$key['smallAreaColor']}}; display: flex; flex-direction: column;justify-content: center;">
                                    @endif
                                    ...
                                    <div id="nextBanner" class="fas fa-chevron-right text-dark"
                                        style="scale:1; padding: 1rem; border: 1px solid grey; border-radius: 30%;">
                                    </div>
                                </div>
                            </div>
                </center>
    ...
    <div class="bannerSlides">
        ...
        <a href="{{$key['link']}}" target="_blank">
            <div class="bannerSlides-content" data-duration="{{ $key['duration'] }}">
